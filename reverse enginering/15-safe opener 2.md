...
## Solucion
descargamos el archivo java y lo descompilamos utilizando una herramienta online en este caso
http://www.javadecompilers.com/
y obtenemos el siguiente codigo en el que la bandera esta a simple vista
```java
